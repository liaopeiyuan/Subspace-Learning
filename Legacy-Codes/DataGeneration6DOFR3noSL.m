function []=DataGeneration6DOFR3noSL(n,entry,orientation)
%clear all; 
...
%Initializing
[ M,                        bMap         ]  = binaryMap6DOFR3noSL(H,xmax,xmin,ymax,ymin,zmax,zmin,deltaX,deltaY,deltaZ,angleX,angleY,angleZ);
...
filename = horzcat('6DOFR3noSL.','n',num2str(n),'.','L',num2str(l),'.',datestr(datetime('now'),'mm.dd.yy.HH.MM'),'.mat');
