...
\\Data Generation for 0Neural Network//
%}

%clear all; 
function []=DataGeneration5DOFR3(n,entry,orientation)
...
%Initializing
[ M,                        bMap         ]  = binaryMap5DOFR3(H,xmax,xmin,ymax,ymin,zmax,zmin,deltaX,deltaY,deltaZ,angleX,angleY,angleZ);
...
filename = horzcat('5DOFR3.','n',num2str(n),'.','L',num2str(l),'.',datestr(datetime("now"),'mm.dd.yy.HH.MM'),'.mat');
