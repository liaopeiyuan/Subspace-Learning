...
%clear all; 
function []=DataGeneration6DOFSO3(n,entry,point)
...
%Initializing
[ M,                        bMap ]  = binaryMap6DOFSO3(H,xmax,xmin,ymax,ymin,zmax,zmin,deltaX,deltaY,deltaZ,dispX,dispY,dispZ);
...
filename = horzcat('6DOFSO3.','n',num2str(n),'.','L',num2str(l),'.',datestr(datetime("now"),'mm.dd.yy.HH.MM'),'.mat');
