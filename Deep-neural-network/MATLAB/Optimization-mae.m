        ...
        save(strcat('section6_5_mae_rp','.mat'),'section6_5','tr','-v7.3')
        ...
        [section6_5,tr] = train(section6_5,resM,resB,'useGPU','yes');
        save(strcat('section6_5_mae_scg','.mat'),'section6_5','tr','-v7.3')
        ...
        [section6_5,tr] = train(section6_5,resM,resB,'useGPU','yes');
        save(strcat('section6_5_mae_cgb','.mat'),'section6_5','tr','-v7.3')
        ...
        [section6_5,tr] = train(section6_5,resM,resB,'useGPU','yes');
        save(strcat('section6_5_mae_oss','.mat'),'section6_5','tr','-v7.3')
        ...
        [section6_5,tr] = train(section6_5,resM,resB,'useGPU','yes');
        save(strcat('section6_5_mae_gdx','.mat'),'section6_5','tr','-v7.3')