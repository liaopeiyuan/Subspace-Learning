for j=1:4
        ...
        save(strcat('section6_5_crossentropy_rp','_',num2str(j),'.mat'),'net','tr','-v7.3')
...
for j=1:4
        ...
        [section6_5,tr] = train(section6_5,resM,resB,'useGPU','yes');
        save(strcat('section6_5_crossentropy_scg','_',num2str(j),'.mat'),'net','tr','-v7.3')
...
for j=1:4
        ...
        [section6_5,tr] = train(section6_5,resM,resB,'useGPU','yes');
        save(strcat('section6_5_crossentropy_cgb','_',num2str(j),'.mat'),'net','tr','-v7.3')
...
for j=1:4
        ...
        [section6_5,tr] = train(section6_5,resM,resB,'useGPU','yes');
        save(strcat('section6_5_crossentropy_oss','_',num2str(j),'.mat'),'net','tr','-v7.3')
...
for j=1:4
        ...
        [section6_5,tr] = train(section6_5,resM,resB,'useGPU','yes');
        save(strcat('section6_5_crossentropy_gdx','_',num2str(j),'.mat'),'net','tr','-v7.3')
